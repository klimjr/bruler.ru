...
class ChangePasswordCodeNotification extends Notification
{
  ...
  public function toMail(User $notification)
  {
    ...
    return (new MailMessage)
      ...
      ->line(Markdown::parse("<p style='margin: 0 auto 10px auto; max-width: 500px; font-size: 15px'>Код для смены пароля: <span style='font-weight: 700'>$recovery_code</span></p>"))
